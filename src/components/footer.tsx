...
const Footer = () => {
  return (
    <div
      id="footer"
      className="max-w-full px-2  md:px-10  mt-44 py-3 flex flex-col md:flex-row bg-[#d30202] "
    >
      <div className="w-auto md:w-2/6 mx-4">
        <ul className=" text-base text-white md:mx-auto flex flex-col px-6 ">
          <h3 className="text-2xl font-bold py-3 text-red-200">Links</h3>
      ...
      <ul className=" w-auto  md:w-2/6 mx-4 md:mx-auto flex text-base text-white  flex-col px-6">
        <h3 className=" text-2xl font-bold py-3 text-red-200">Contact Us Today</h3>
        <span className="py-1">
          Email:
          {/* fipco@gmail.com */}
        </span>
